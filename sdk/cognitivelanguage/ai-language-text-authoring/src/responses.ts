...
export interface TextAnalysisAuthoringListProjects200Response
...
/** Lists the existing projects. */
export interface TextAnalysisAuthoringListProjectsDefaultResponse
  extends HttpResponse {
  status: string;
...
export interface TextAnalysisAuthoringCreateProject200Response
  extends HttpResponse {
  status: "200";
...
/** Creates a new project or updates an existing one. */
export interface TextAnalysisAuthoringCreateProject201Response
  extends HttpResponse {
  status: "201";
  body: ProjectMetadataOutput;
}
...
/** Creates a new project or updates an existing one. */
export interface TextAnalysisAuthoringCreateProjectDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetProject200Response
  extends HttpResponse {
  status: "200";
  body: ProjectMetadataOutput;
}
...
/** Gets the details of a project. */
export interface TextAnalysisAuthoringGetProjectDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
/** Deletes a project. */
export interface TextAnalysisAuthoringDeleteProject202Response
  extends HttpResponse {
  status: "202";
...
/** Deletes a project. */
export interface TextAnalysisAuthoringDeleteProjectDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
/** Triggers a job to export a project's data. */
export interface TextAnalysisAuthoringExportDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
/** Triggers a job to import a project. If a project with the same name already exists, the data of that project is replaced. */
export interface TextAnalysisAuthoringImportDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
/** Triggers a training job for a project. */
export interface TextAnalysisAuthoringTrainDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringListDeployments200Response
  extends HttpResponse {
  status: "200";
...
/** Lists the deployments belonging to a project. */
export interface TextAnalysisAuthoringListDeploymentsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringSwapDeployments202Response
  extends HttpResponse {
  status: "202";
  body: Record<string, unknown>;
...
/** Swaps two existing deployments with each other. */
export interface TextAnalysisAuthoringSwapDeploymentsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetDeployment200Response
  extends HttpResponse {
  status: "200";
...
/** Gets the details of a deployment. */
export interface TextAnalysisAuthoringGetDeploymentDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringDeployProject202Response
  extends HttpResponse {
  status: "202";
  body: Record<string, unknown>;
...
/** Creates a new deployment or replaces an existing one. */
export interface TextAnalysisAuthoringDeployProjectDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringDeleteDeployment202Response
  extends HttpResponse {
  status: "202";
  body: Record<string, unknown>;
...
/** Deletes a project deployment. */
export interface TextAnalysisAuthoringDeleteDeploymentDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringDeleteDeploymentFromResources202Response
  ...
  headers: RawHttpHeaders &
    TextAnalysisAuthoringDeleteDeploymentFromResources202Headers;
}
...
export interface TextAnalysisAuthoringGetDeploymentStatus200Response
  extends HttpResponse {
  status: "200";
  body: DeploymentJobStateOutput;
}
...
/** Gets the status of an existing deployment job. */
export interface TextAnalysisAuthoringGetDeploymentStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetSwapDeploymentsStatus200Response
  extends HttpResponse {
  status: "200";
  body: DeploymentJobStateOutput;
}
...
/** Gets the status of an existing swap deployment job. */
export interface TextAnalysisAuthoringGetSwapDeploymentsStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetExportStatus200Response
  extends HttpResponse {
  status: "200";
...
/** Gets the status of an export job. Once job completes, returns the project metadata, and assets. */
export interface TextAnalysisAuthoringGetExportStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetImportStatus200Response
  extends HttpResponse {
  status: "200";
...
/** Gets the status for an import. */
export interface TextAnalysisAuthoringGetImportStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringListTrainedModels200Response
  extends HttpResponse {
  status: "200";
...
/** Lists the trained models belonging to a project. */
export interface TextAnalysisAuthoringListTrainedModelsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetTrainedModel200Response
  extends HttpResponse {
  status: "200";
...
/** Gets the details of a trained model. */
export interface TextAnalysisAuthoringGetTrainedModelDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringDeleteTrainedModel204Response
  extends HttpResponse {
  status: "204";
  body: Record<string, unknown>;
}
...
/** Deletes an existing trained model. */
export interface TextAnalysisAuthoringDeleteTrainedModelDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringLoadSnapshot202Response
  extends HttpResponse {
  status: "202";
  body: Record<string, unknown>;
...
/** Restores the snapshot of this trained model to be the current working directory of the project. */
export interface TextAnalysisAuthoringLoadSnapshotDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetModelEvaluationResults200Response
  extends HttpResponse {
  status: "200";
...
export interface TextAnalysisAuthoringGetModelEvaluationSummary200Response
  extends HttpResponse {
  status: "200";
...
export interface TextAnalysisAuthoringGetLoadSnapshotStatus200Response
  extends HttpResponse {
  status: "200";
...
/** Gets the status for loading a snapshot. */
export interface TextAnalysisAuthoringGetLoadSnapshotStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringListDeploymentResources200Response
  extends HttpResponse {
  status: "200";
...
/** Lists the deployments resources assigned to the project. */
export interface TextAnalysisAuthoringListDeploymentResourcesDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringAssignDeploymentResources202Response
  extends HttpResponse {
  status: "202";
  body: Record<string, unknown>;
  headers: RawHttpHeaders &
    TextAnalysisAuthoringAssignDeploymentResources202Headers;
}
...
export interface TextAnalysisAuthoringUnassignDeploymentResources202Response
  extends HttpResponse {
  status: "202";
  body: Record<string, unknown>;
  headers: RawHttpHeaders &
    TextAnalysisAuthoringUnassignDeploymentResources202Headers;
}
...
export interface TextAnalysisAuthoringListTrainingJobs200Response
  extends HttpResponse {
  status: "200";
...
/** Lists the non-expired training jobs created for a project. */
export interface TextAnalysisAuthoringListTrainingJobsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetTrainingStatus200Response
  extends HttpResponse {
  status: "200";
...
/** Gets the status for a training job. */
export interface TextAnalysisAuthoringGetTrainingStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringCancelTrainingJob202Response
  extends HttpResponse {
  status: "202";
  body: Record<string, unknown>;
...
/** Triggers a cancellation for a running training job. */
export interface TextAnalysisAuthoringCancelTrainingJobDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetProjectDeletionStatus200Response
  extends HttpResponse {
  status: "200";
...
/** Gets the status for a project deletion job. */
export interface TextAnalysisAuthoringGetProjectDeletionStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringGetSupportedLanguages200Response
  extends HttpResponse {
  status: "200";
...
/** Lists the supported languages. */
export interface TextAnalysisAuthoringGetSupportedLanguagesDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface TextAnalysisAuthoringListTrainingConfigVersions200Response
  extends HttpResponse {
  status: "200";
